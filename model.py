...
class GeneratorResNet(nn.Module):
    def __init__(self, input_shape, num_residual_blocks):
        ...
        # Output layer
        model += [nn.ReflectionPad2d(channels), nn.Conv2d(out_features, channels, 7), nn.BatchNorm2d(out_features), nn.Tanh()]
...
class Generator(nn.Module):
    def __init__(self, input_channel, output_channel,num_residual, final_output_c=1): # 3, 64, 3, 9
        ...
        #self.batch_norm = nn.BatchNorm2d(input_channel)  # try bn
